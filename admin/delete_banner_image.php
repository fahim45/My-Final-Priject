...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-6"style="background:#F5F5F5;min-height:510px">
	<div class="panel panel-default"style="margin-left:0px;">
        <div class="panel-heading"style="padding:1px 15px">
              <h4 style="text-align:center;">Delete Banner image</h4>
        </div>
         <div class="panel-body" style="overflow-y: scroll;height:450px;">
        	<a href="insert_banner_image.php?lang_id=<?php echo $lang_id;?>" class="btn btn-success pull-right"> Add Banner Image</a>

		
			<?php
				$statement=$db->prepare("delete from tbl_banner where banner_id=?");
				$statement->execute(array($id));
				echo 'The Banner Image has been deleted successfully.';
