...
if(isset($_POST['form1'])) 
{
	...
	try {
			...
			$statement=$db->prepare("show table status like 'tbl_footer_logo'");
			$statement->execute();
			...
			$statement=$db->prepare("insert into tbl_footer_logo(footer_logo_image) value(?)");
			...
			?>
				<form action="" method="post" enctype="multipart/form-data">
					...
					<table>
						...
						<tr>
							<td><input type="file" name="footer_logo_image" ><br></td>
						</tr>
