			 ...
			 <div class="panel panel-default"style="margin-left:0px;">
                    ...
                    <div class="panel-body" style="overflow-y: scroll;height:450px;">
                                   ...
                                   <?php
                                        ...
                                        <br>
                                        <a href="edit_logo_image.php?id=<?php echo $row['logo_id']?>&lang_id=<?php echo $lang_id;?>">Edit</a>
                                             <a href="delete_logo_image.php?id=<?php echo $row['logo_id']?>&lang_id=<?php echo $lang_id;?>">Delete</a>
